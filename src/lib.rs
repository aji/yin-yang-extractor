...
pub use pzpr_codec::grid::Grid;
pub use pzpr_codec::variety::yinyang::Cell;

pub fn extract_from_image(img: &GrayImage) -> AnalyzeResult<Grid<Cell>> {
...
pub fn extract_from_image_file(fname: impl AsRef<Path>) -> AnalyzeResult<Grid<Cell>> {
