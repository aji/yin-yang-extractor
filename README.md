...
for each cell into a flat vector and sorts them into 3 classes. It uses a
clustering algorithm that starts with one class per input cell, then iteratively
merges the two classes with the closest centroids.
